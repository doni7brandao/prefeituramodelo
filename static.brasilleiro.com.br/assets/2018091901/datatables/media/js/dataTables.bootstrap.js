...
$(document).ready(function() {
	...
	$('.table.datatable_simple').dataTable( {
		"sDom": "<''<'pull-left'l><'pull-right'f>r>t<''<'pull-left'i><'pull-right'p>>",
		"sPaginationType": "bootstrap",
		"bSort": false,
		"bStateSave": true,
	...
	$('.table.normal-first-asc').dataTable( {
	...
	$('.table.legislacao').dataTable( {
		"sDom": "<''<'pull-left'l><'pull-right'f>r>t<''<'pull-left'i><'pull-right'p>>",
		"sPaginationType": "bootstrap",
		"aaSorting": [[ 1, "asc" ]],
		"aoColumns": [{"sType": "natural"},null,null,null],
		"bStateSave": true,
		"fnStateSave": function (oSettings, oData) {
			localStorage.setItem( 'DataTables_'+window.location.pathname, JSON.stringify(oData) );
		},
	...
	$('.table.legislacaoadmin').dataTable( {
		"sDom": "<''<'pull-left'l><'pull-right'f>r>t<''<'pull-left'i><'pull-right'p>>",
		"sPaginationType": "bootstrap",
		"aaSorting": [[ 1, "asc" ]],
